...
//			}
	...
	public static void clickOnsettingIcon() throws Exception {
		//AppFunctions.Functions.verifyElement(ByAccessibilityId("Setting Icon"));
			try {
				...
				System.out.println("Clicking on Setting Icon");
				logStep("Clicking on Setting Icon");
				new WebDriverWait(Ad, Functions.maxTimeout).until(ExpectedConditions.elementToBeClickable(Ad.findElementById("com.weather.Weather:id/avatar_icon")));
				Ad.findElementById("com.weather.Weather:id/avatar_icon").click();
				Thread.sleep(5000);
			}
		}
